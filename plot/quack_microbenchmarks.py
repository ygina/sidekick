...
def plot_num_missing_vs_decode_time(args, pdf):
    ...
    data['b=8'] = [0.735296,1.542838,2.333808,3.139334,3.961185,4.759707,5.554976,6.37912,7.21299,8.022811,8.857015,9.696321,10.50598,11.358232,12.200637,13.042978,13.894273,14.894371,15.621187,16.48187,17.369348,18.282124,19.107936,20.006794,20.905617,21.752102,22.656915,23.547296,24.464507,25.366101]
    plot_graph(xs, data, [x for x in sorted(data.keys())],
...
def plot_threshold_vs_encode_time(args, pdf):
    ...
    data['b=8'] = [0.0,0.354,0.748,1.128,1.496,1.878,2.265,2.64,3.025,3.401,3.79,4.169,4.541,4.934,5.302,5.676,6.075,6.44,6.826,7.205,7.592,7.964,8.335,8.717,9.095,9.478,9.892,10.247,10.621,11.008,11.374]
    plot_graph(xs, data, [x for x in sorted(data.keys())],
