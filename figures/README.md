...
TODO: pass subpath ratio as parameter.

```
cd $QUICHE_HOME && make retx_psum && cd $SIDECAR_HOME
...
```
cd $QUICHE_HOME && make ackr_psum && cd $SIDECAR_HOME
...
cd $QUICHE_HOME && make retx_strawman_a && cd $SIDECAR_HOME
...
cd $QUICHE_HOME && make retx_strawman_b && cd $SIDECAR_HOME
...
cd $QUICHE_HOME && make retx_strawman_c && cd $SIDECAR_HOME
...
cd $QUICHE_HOME && make ackr_strawman_a && cd $SIDECAR_HOME
...
cd $QUICHE_HOME && make ackr_strawman_b && cd $SIDECAR_HOME
...
cd $QUICHE_HOME && make ackr_strawman_c && cd $SIDECAR_HOME
